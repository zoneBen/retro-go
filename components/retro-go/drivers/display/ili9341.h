...
// Support both RG_SCREEN_ROTATION and RG_SCREEN_ROTATE (backward compatibility)
#if defined(RG_SCREEN_ROTATION) || defined(RG_SCREEN_ROTATE)
    #ifndef RG_SCREEN_ROTATION
        #define RG_SCREEN_ROTATION RG_SCREEN_ROTATE
    #endif
    #ifndef RG_SCREEN_RGB_BGR
